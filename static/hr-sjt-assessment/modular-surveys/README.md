...
Optional demographics: open `demographics.html` from the hub anytime (separate from packs 01–08). Student vs HR professional is chosen there (large card buttons), not on the hub.  
